...
*El ALMA, el elemento que controla directamente el Jugador — no Kris.*

*Nota de tabla: el Jugador no tiene sprite propio, pero el juego lo representa mecánicamente a través del ALMA (SOUL), el corazón rojo que se mueve de forma independiente al propio Kris.*

> [!info]+ Datos rápidos
> 🕹️ Es la persona real que controla a Kris a través del ALMA — mueve el personaje, navega los menús, elige diálogos y decide las acciones de combate.
> 👻 El propio juego confirma, mecánicamente, que el Jugador y Kris son entidades separadas: varias veces a lo largo de la serie, Kris se arranca el ALMA del pecho y actúa por su cuenta, dejando al Jugador sin ningún control.
> 🎙️ En la introducción del Cap.1, una voz sin cuerpo pregunta directamente "¿estás conectado?" antes de guiar al Jugador a diseñar un "VESSEL" (vasija) y ponerle nombre — y luego pide el nombre real de quien está jugando.
> 🗑️ Justo después, una segunda entidad interrumpe la creación de ese Vessel, declara que será "descartado" ("nadie puede elegir quién es en este mundo") y asigna la conexión del Jugador a Kris en su lugar — sin que quede claro quién es esa segunda voz.
> ❄️ La Ruta Snowgrave del Cap.2 es el ejemplo más citado de esta tensión: Noelle llega a cuestionar en voz alta si de verdad es Kris quien está haciendo "esto", insinuando que percibe la diferencia entre Kris y quien lo controla.

> [!tip]- Ficha de personalidad
> No tiene personalidad propia dentro de la ficción — es, literalmente, quien está al otro lado de la pantalla. El juego lo trata unas veces como una presencia casi invasora (la voz inicial, el propio nombre que se le pide), y otras como una entidad que Kris tolera, ignora o rechaza abiertamente según el momento.
...
>
> Si la ruta no se aborta, Kris le vuelve a clavar el ThornRing a Noelle en la mano y, ya en el baño de la casa, **se arranca el ALMA, la tira a la papelera y la patea repetidamente con auténtica rabia** — hasta que Asgore lo interrumpe para avisar de que Carol quiere que todos se vayan. Al dar el primer paso tras esto, Kris cae al suelo antes de levantarse; su HP baja a 10 como resultado directo de la paliza que él mismo (o el ALMA) acaba de recibir.
>
> ![[Kris_screenshot_kicking_SOUL.png]]
> *Kris, ya sin el ALMA, pateándola dentro de la papelera del baño — Cap.4, Ruta Rara.*
>
...
> [!quote]- Ángel
> La teoría más extendida de todo el fandom es que el Ángel de la Profecía y el Jugador son, en el fondo, la misma idea — desarrollada a fondo en la teoría de más abajo. [[Ángel]]
...
- Tasque Manager, en la iglesia del Cap.5, es una de las pocas veces que un personaje del elenco se dirige a Kris por su nombre de forma directa — un pequeño contraste con el resto del juego, que trata a Kris casi siempre como el "Vessel" genérico del Jugador.
