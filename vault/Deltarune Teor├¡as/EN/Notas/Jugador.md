...
> Before Kris exists, with the game window literally titled "CONTACT," a bodiless voice asks the Player if they're "connected" [TODO: verify exact EN quote]. The moment it's confirmed, the voice announces "WE MAY BEGIN." and a red SOUL appears: the voice guides the construction of a body — a "VESSEL" — choosing a head (8 options), body (6), and legs (5): every selectable piece appears in grayscale. It also asks what "gift" it should have (MIND by default) and two yes/no questions about accepting "the possibility of pain and convulsions" [TODO: verify exact EN quote] — answering no to either changes nothing: the voice replies "UNDERSTOOD" [TODO: verify exact EN quote] and continues regardless, giving no real chance to back out.
>
> ![[Voice_screenshot_connection.png]]
> *"WE MAY BEGIN." — the Voice, right after confirming the connection, before starting to build the Vessel.*
>
> Partway through selecting pieces, the Voice itself marks the progress: "THE HALFWAY MARK HAS BEEN ATTAINED."
>
> ![[Voice_screenshot_halfway_mark.png]]
> *"THE HALFWAY MARK HAS BEEN ATTAINED." — the Voice, halfway through the Vessel's creation.*
>
...
> Whoever guides the creation of the first Vessel in the Chapter 1 intro —and who speaks again during the battle against the Roaring Knight— is, almost certainly, the same "Voice." The "Gaster's List" theory (internal name GONERMAKER, the Vessel labeled "GONER," the grayscale shared with the Goners, the shared musical leitmotif) and the Voice's full development —screenshots included— live in Gaster's own note. [[Gaster (W. D. Gaster)]]
...
>
> ![[player_soul_discarded_voice.png]]
> *"Will now be discarded." — the exact moment this second voice discards the first Vessel.*
