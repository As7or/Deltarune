...
> 👑 Anuncia la reunión de tres héroes —un humano, un monstruo y un príncipe de la oscuridad— para sellar las fuentes y "desterrar el Cielo del Ángel".
> ⚔️ Incluye el duelo contra el Caballero, referido solo por su título, nunca por nombre.
> 🎤 Se revela también en el Cap.4 en forma de himno cantado en el Mundo Claro, y de una "lectura" que da Catty en la iglesia.
> ✒️ El único personaje mencionado por nombre en toda la leyenda es Jockington.

> [!tip]- El texto completo
> > Hace mucho tiempo, se susurró una LEYENDA entre las sombras.
> > Esta es la leyenda de DELTA RUNE.
> > Durante milenios, LUZ y OSCURIDAD han vivido en equilibrio,
> > trayendo paz al MUNDO.
> > Pero si esta armonía se rompiera...
> > ocurriría una calamidad terrible.
> > El cielo se teñirá de negro con terror
> > y la tierra se resquebrajará de miedo.
> > Entonces, con el corazón latiendo con fuerza...
> > la TIERRA dará su último aliento.
> > Solo entonces, brillando con esperanza...
> > Tres HÉROES aparecerán al borde de los MUNDOS.
> > Un HUMANO, un MONSTRUO,
> > y un PRÍNCIPE DE LA OSCURIDAD.
> > Solo ellos podrán sellar las fuentes
> > y desterrar el CIELO DEL ÁNGEL.
...
Los Santuarios Oscuros del Cap.4 reparten **35 tapices/vidrieras de cristal** por el escenario, cada uno con su propia imagen y una línea de texto — juntos forman una versión mucho más larga y en verso rimado de la Profecía que la que resume Ralsei en el Cap.1. Los 35 gifs de cada vidriera están guardados en `Sprites/` (numerados del 01 al 35, en el orden exacto en que aparecen). Esta sección las analiza una por una, agrupadas por bloques temáticos.

> [!info]- Cómo leer esta sección
> Cada entrada da la frase original en inglés (el idioma en que está el asset), una traducción libre, y qué conecta con el resto del vault. Cuando la conexión es una lectura mía razonada a partir del propio texto, lo marco como tal — el texto en sí es 100% oficial, la interpretación de qué significa cada línea suelta no siempre lo es.

### Bloque 1 — El origen del mundo (vidrieras 1-6)

Esta primera tanda es, en esencia, una reformulación en verso de la "Leyenda de Delta Rune" que Ralsei ya resume en el Cap.1 — pero con más detalle, incluyendo el primer texto in-game que conecta directamente el Rugido con los Titanes.
...
> Título de apertura de toda la secuencia.

> [!example]- 02 — "The Legend of this World. &lt;DELTARUNE.&gt;"
> *"La Leyenda de este Mundo. &lt;DELTA RUNE.&gt;"*
> ![[02_la_leyenda_de_este_mundo.gif]]
> Presenta el nombre del propio juego dentro de la ficción, como ya hace la versión en prosa del Cap.1.

> [!example]- 03 — "A world basked in purest light. Beneath it, grew eternal night."
> *"Un mundo bañado en la luz más pura. Bajo él, creció la noche eterna."*
> ![[03_mundo_banado_en_luz_pura.gif]]
> El equivalente en verso a "durante milenios, Luz y Oscuridad han vivido en equilibrio" del texto que recita Ralsei.

> [!example]- 04 — "If Fountains freed, the Roaring cries. And Titans shape from darkened eyes."
> *"Si las Fuentes se liberan, el Rugido clama. Y Titanes toman forma de ojos oscurecidos."*
> ![[04_si_las_fuentes_se_liberan_el_rugido.gif]]
> **La primera mención textual directa del Rugido y los Titanes dentro de la propia Profecía** — hasta ahora solo lo explicaba Ralsei de viva voz en el Cap.2 (ver [[Titan]]). Confirma que el Titán del Cap.4 no es un capricho puntual del guion, sino el cumplimiento literal de esta línea profética.

> [!example]- 05 — "The Light and Dark, both burning dire. A countdown to the Earth's expire."
> *"La Luz y la Oscuridad, ambas ardiendo funestas. Una cuenta atrás para el fin de la Tierra."*
> ![[05_luz_y_oscuridad_ambas_ardiendo.gif]]
> Corresponde a "la tierra dará su último aliento" del texto en prosa.

> [!example]- 06 — "But lo, on hopes and dreams they send. Three Heroes at the World's End."
> *"Pero he aquí, con esperanzas y sueños los envían. Tres Héroes al Fin del Mundo."*
> ![[06_con_esperanzas_y_suenos_tres_heroes.gif]]
> El anuncio formal de los tres héroes — a partir de aquí empieza el bloque que los presenta uno por uno.

### Bloque 2 — Los tres héroes, numerados y descritos (vidrieras 7-13)
...
### Bloque 3 — Los presagios del Caballero y sus enemigos (vidrieras 14-19)
...
> Posible conexión con el "Cielo del Ángel" que hay que desterrar según el texto en prosa — ver [[Ángel (Jugador)]].
...
> - Es sinónimo de **refugio** — de ahí que buena parte del fandom lea esta línea como un anticipo directo del propio [[Shelter]], mucho antes de que el Cap.5 confirmara la relación real de Asgore con esa zona.
> - Encaja con que Flower King —su propia floristería— sea, en la práctica, su "asilo" personal: el lugar donde ha vivido solo, cuidando las 7 Flores mucho más allá de su vida natural (ver [[7 Flores de Colores]]), desde que se divorció de Toriel.
...
> Cierre de la secuencia, centrado enteramente en ella.

## Relaciones

> [!quote]- FRIEND
> La vidriera 15 ("They'll see the tail of Hell take crawl") es la línea que el fandom apoda "la Cola del Infierno" — el sobrenombre más extendido para referirse a él. **Teoría de fans muy extendida, sin confirmar con nombre propio.** [[FRIEND]]

> [!quote]- Asgore
> La vidriera 20 ("The Flower Man, trapped in asylum") lo muestra confirmado como antagonista del Cap.5, con las manos alrededor de una flor y una corona que nunca lleva en el Mundo Claro. [[Asgore]]

> [!quote]- Shelter
> "Atrapado en el asilo" de la vidriera 20 es, para buena parte del fandom, un anticipo directo de esta misma zona — "asilo" y "refugio" son sinónimos en inglés (*asylum*/*shelter*). [[Shelter]]
...
> [!quote]- Ángel (Jugador)
> El "Cielo del Ángel" que hay que desterrar según la Profecía es una de las conexiones más directas del texto con la propia figura del Jugador/Ángel dentro de la ficción. [[Ángel (Jugador)]]

> [!quote]- Gaster (W. D. Gaster)
> La frase "las sombras cortan profundo" del himno coincide casi textualmente con una línea asociada a su Entry Number Seventeen en Undertale. [[Gaster (W. D. Gaster)]]

> [!quote]- Titan
> La vidriera 04 ("If Fountains freed, the Roaring cries. And Titans shape from darkened eyes") es la primera mención textual directa del Rugido y los Titanes dentro de la propia Profecía, antes incluso de que Ralsei lo explique de viva voz en el Cap.2. [[Titan]]
...
> [!quote]- Gerson Boom
> La vidriera 30 ("Axe carved by the tortoise's grand hammer") es una de las conexiones más sólidas de todo el análisis: "la tortuga" es, literalmente, Gerson Boom, y su arma como Hammer of Justice es un hacha/martillo. Pero la conexión más grande es otra: Gerson es el autor de *Lord of the Hammer*, una novela inspirada directamente en esta misma Profecía, con títulos de capítulo que reflejan casi palabra por palabra los capítulos reales del propio juego — ver vidriera 20, más arriba. Su estudio, además, está justo al lado de la Galería (vidriera 33) donde se esconde un libro misterioso. [[Gerson Boom]]

> [!quote]- Jockington
> La vidriera 21 ("Jockington grows the beard") es la línea exacta que confirma que es el único personaje mencionado por su nombre propio en toda la Profecía. [[Jockington]]

> [!quote]- Dess
> La vidriera 16 ("The Knight which makes with blackened knife") menciona el cuchillo negro del Caballero, el mismo objeto que sostiene la teoría de si Dess es el Caballero Rugiente. [[Dess]]

> [!quote]- Queen
> La vidriera 18 ("The Queen's chariot cannot be stopped") encaja temáticamente con su GIGA Queen del Cap.2 — un "carro" mecánico e imparable. **Lectura razonada, sin confirmación textual directa.** [[Queen]]

> [!quote]- Lancer
> La vidriera 22 ("The pointy-headed will say 'toothpaste,' and then 'boy.'") parece describirlo por su diseño — existe incluso un sprite del vault (`lancer_Darkner_face_profecy.png`) que refuerza esta misma lectura. **Sin confirmación textual directa.** [[Lancer]]

> [!quote]- Tenna
> La vidriera 19 ("The Lord of Screens cleaved red by blade") es él: "el Señor de las Pantallas" partido por la espada del Caballero, que le corta los brazos tras derrotarlo en el Cap.3. [[Tenna]]
>
> ![[tenna_profecy.webp]]
...
## Submapa
[[Submapas/Profecía.canvas|Abrir submapa gráfico]]
