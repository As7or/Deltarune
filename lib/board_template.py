...
<style>
  ...
  /* Textura de corcho en su propia capa, detras de las tarjetas. Nitida (sin
     desenfoque) pero con el contraste y el grano rebajados -- el jpeg de
     fondo se notaba "ruidoso" (mucho contraste local entre manchas claras y
     oscuras muy juntas), no borroso; la solucion es aplanar ese contraste,
     no difuminarlo. */
  #cork-bg{{
    position:absolute; inset:0; z-index:0; pointer-events:none;
    filter: contrast(0.7) brightness(1.1) saturate(0.92);
    background-image:
      ...
      radial-gradient(circle at 8% 15%, rgba(80,50,20,.3) 0, transparent 1.4px),
      radial-gradient(circle at 63% 41%, rgba(80,50,20,.28) 0, transparent 1.1px),
      radial-gradient(circle at 27% 68%, rgba(80,50,20,.28) 0, transparent 1.3px),
      radial-gradient(circle at 91% 77%, rgba(80,50,20,.24) 0, transparent 1px),
      radial-gradient(circle at 47% 92%, rgba(255,220,170,.08) 0, transparent 1.2px),
      radial-gradient(circle at 75% 22%, rgba(255,220,170,.06) 0, transparent 1px),
...
function applyTransform(){{
  ...
  corkBg.style.backgroundPosition = `${{panX}}px ${{panY}}px`;
  corkBg.style.backgroundSize = `auto, auto, auto, auto, auto, auto, ${{46*zoom}}px ${{46*zoom}}px, ${{38*zoom}}px ${{38*zoom}}px, ${{52*zoom}}px ${{52*zoom}}px, ${{41*zoom}}px ${{41*zoom}}px, ${{33*zoom}}px ${{33*zoom}}px, ${{44*zoom}}px ${{44*zoom}}px, ${{300*zoom}}px ${{300*zoom}}px`;
}}
applyTransform();
