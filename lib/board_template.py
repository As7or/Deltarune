...
<style>
  ...
  /* Textura de corcho en su propia capa, detras de las tarjetas, con un
     leve desenfoque -- el jpeg de fondo se notaba "ruidoso"/con grano al
     verlo de cerca o al hacer zoom (es una textura rasterizada, asi que
     ampliarla siempre se iba a notar); desenfocarla un poco la deja con
     aspecto de corcho real en vez de estatica, a cualquier zoom. */
  #cork-bg{{
